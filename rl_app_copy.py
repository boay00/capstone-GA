...
rank_images = {}
rank_images['Bronze 1'] = Image.open('ranks/b1.png')
rank_images['Bronze 2'] = Image.open('ranks/b2.png')
rank_images['Bronze 3'] = Image.open('ranks/b3.png')
rank_images['Silver 1'] = Image.open('ranks/s1.png')
rank_images['Silver 2'] = Image.open('ranks/s2.png')
rank_images['Silver 3'] = Image.open('ranks/s3.png')
rank_images['Gold 1'] = Image.open('ranks/g1.png')
rank_images['Gold 2'] = Image.open('ranks/g2.png')
rank_images['Gold 3'] = Image.open('ranks/g3.png')
rank_images['Platinum 1'] = Image.open('ranks/p1.png')
rank_images['Platinum 2'] = Image.open('ranks/p2.png')
rank_images['Platinum 3'] = Image.open('ranks/p3.png')
rank_images['Diamond 1'] = Image.open('ranks/d1.png')
rank_images['Diamond 2'] = Image.open('ranks/d2.png')
rank_images['Diamond 3'] = Image.open('ranks/d3.png')
rank_images['Champion 1'] = Image.open('ranks/c1.png')
rank_images['Champion 2'] = Image.open('ranks/c2.png')
rank_images['Champion 3'] = Image.open('ranks/c3.png')
rank_images['Grand Champion 1'] = Image.open('ranks/gc1.png')
rank_images['Grand Champion 2'] = Image.open('ranks/gc2.png')
rank_images['Grand Champion 3'] = Image.open('ranks/gc3.png')
